...
<form onSubmit={handleSubmit}> 
  ...
  <div className='mb-5'>
  <input type="text" placeholder='BloadType' name='bloodtype'
...
focus:outline-none'>
 ...
 {
formData.photo &&    <figure className='w-[50px] h-[50px] rounded-full border-2 border-solid border-primaryColor
